...
public final class OrderAcknowledgedEncoder
{
    ...
    private final OrderAcknowledgedEncoder parentMessage = this;
    ...
    public OrderAcknowledgedEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderAcknowledgedEncoder wrapAndApplyHeader(
    ...
    public OrderAcknowledgedEncoder orderId(final long value)
    {
    ...
    public OrderAcknowledgedEncoder status(final short value)
    {
